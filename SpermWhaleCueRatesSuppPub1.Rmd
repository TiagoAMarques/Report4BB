...
This stuff below is currently not being implemented given a weird fact I ma looking into. 

We have `r nrow(tags)` tags in the object `tags`, fit a model to this same object `tags`, and yet the model summary reports only `r `length(residuals(crglmer))` observations? How come we loose 3 observation in this process? Such a weird thing...?
